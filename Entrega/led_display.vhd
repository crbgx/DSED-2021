...
begin
    ...
    case state is
        -- Cada estado activa el digito 0 o 1. De esta forma se barre el display 
        -- pintando cada digito durante 10ms para un reloj de 12 MHz
        when dig0 =>
...
-- Para el primer digito se asigna directamente n con el indice num hasta 10,   
-- para los siguientes valores hasta 20 es necesario restar 10 a numeric_bit
...
-- Los valores del volumen oscilan solo entre 0 y 20, por lo que el digito 1  
-- solo mostrará los valores 0 (no encendemos ningun led), 1 y 2    
